# ARCHIVED - Pre-handoff README and Checkpoint History

> **REFERENCE ONLY - NOT CURRENT STATUS OR AN EXECUTION GOAL.** This retired
> README accumulated several dated checkpoints, including superseded R3
> pre-launch statements. Do not follow its old launch or research instructions.
> Read the repository-root README and `plan.md` for the current handoff.

A Blender-authored, Three.js-based Mid Creek experiment.

## Implementation checkpoint

**Execution paused September 11, 2026 for a fresh session. U1-U4 complete;
U5 incomplete; U6-U10 pending.** The September 10, 2026 launch authorization
permits implementation on `main` when resumed within its remaining allowance.
The exact user-approved envelope, subsequent credit amendment, pinned input identities, resource
...
The [continuation plan](cs3-research-plan.md#september-11-pause-and-continuation-plan)
separates CS3 integration from AR1's appearance work, which the user reports
has started in another concept-repository session. C5 is the proposed frozen
development baseline, not an approved or promoted production library.
The next CS3 session should implement U6, finish technical asset packaging,
and build the U7 playable without more appearance sweeps. Any provisional
development use must be explicit and hash-bound; no technical, appearance,
performance or publication result is silently waived.
The original heavy-work/closeout deadlines remain September 12, 2026 at
22:28:59/23:28:59 UTC. A fresh session does not restart either clock.
Use the committed [new-session goal](../architecture/cs3-continuation-goal.md)
to resume; do not reuse an earlier blocked-before-U1 or uncommitted-C5 handoff.
...
The C5 correction restores the second reflective band and orange shoulder
piping, shapes calves and boot uppers/soles, and differentiates warmer leather
equipment. Four atlas tests, ten native source tests, the 31-check/30-contact
export/browser run, and 80 isolated/40 hall studies are recorded. Its bounded
source review found no supported correctness blocker; that static review did
not independently rerun the checks or approve appearance. All 211 C5 catalog
images, including the atlas, were receipt-matched. Source and tests are
committed at `9844435`; generated candidate media and operational evidence
remain ignored rather than published as a qualified asset library.
...
The [plan's toolchain decision](cs3-research-plan.md#cs3-toolchain-decision-no-rust) covers
...
| Document | Contents |
| --- | --- |
| [Reviewed plan](cs3-research-plan.md) | Three execution units, settled architecture/site decisions, T1-T9 test map, and performance gates |
| [CS3 blueprint](../architecture/cs3-blueprint.md) | User-approved R3 contracts and ten implementation units; remaining launch-envelope inputs precede execution |
| [Research findings](../research/initial-findings.md) | R1 comparison and fresh R2 export/load results, appearance limits and reproduction procedure |
...
| [Evidence index](../research/evidence-index.md) | Reconciled revisions, inspected source and GitHub discussions/workflows, recorded artifact identities, and evidence limits |
| [Cel Shift source and size audit](../research/cel-shift-source-audit.md) | Existing 49-master inventory, prompt/sidecar provenance, publication blockers, and the documentation-only manifest/atomic-import contract |
| [Deferred work](../../TODOS.md) | The three explicitly selected follow-ups, with rationale, context, and dependencies |
| [R1 handoff and goal prompt](r1-research-handoff.md) | New-session orientation and a copyable research-only goal with a mandatory R1 review stop |
...
The [blueprint](../architecture/cs3-blueprint.md) specifies ten ordered units
...
[R2 findings and reproduction instructions](../research/initial-findings.md#r2-result-reproducible-bounded-exportload-proof)
...
[collects approvals before U1](../architecture/cs3-blueprint.md#one-front-loaded-human-checkpoint).
